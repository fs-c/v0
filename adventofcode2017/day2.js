...
const spreadsheet = `1136	1129	184	452	788	1215	355	1109	224	1358	1278	176	1302	186	128	1148
...
const checksum = a => {
  ...
  a.forEach(row => {
    r += row.sort((a, b) => b - a)[0] - row.sort((a, b) => a - b)[0]
  })
...
const divisibles = a => {
  ...
  a.forEach(row => r += find(row))

  return r
}

console.log(divisibles(parse(spreadsheet)))