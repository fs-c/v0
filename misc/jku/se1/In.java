...
public class In {
	...
	/**
	 * Gets the current available raw characters. In case of an error 0 is returned and
	 * done() yields false.
	 * 
	 ...
	 * 
	 * REMARK: Changed to read to next whitespace in the case of an exception.
	 * Was necessary to escape from infinite loops. 
	 * 
	...
	public static int readInt() {
		...
		try {
			...
			// must read to next whitespace so that subsequent call does not result in infinite loop
	...
	/**
	 * Reads a double value. This method skips white space and tries to read a double
	 * value. If the text does not contain a double value or if the number is not
	 * well-formed, the value 0.0 is returned and the subsequent call of done()
	...
	/**
	 * Peeks at the next character, skips white spaces. 
	 * This method skips white space and returns the
	 * next character without removing it from the input stream. It can be used to
	 * find out, what token comes next in the input stream.
	 * 
	...
	/**
	 * Peeks at the next character, does NOT skip white spaces. 
	 * It can be used to find out, what character comes next in the input stream.
	 * In distinction to peek, this method does not skip white spaces. 
	 * 
	...
	/**
	 * Opens a text file for reading. The text file with the name fn is opened as the
	 * new current input file. When it is closed again, the previous input file is
	 * restored.
	 * 
	...
	/**
	 * Checks if the end of a file is reached. Should be used with reading files only. 
	 * Not useful when reading from the interactive console. 
	 * 
